...
def main():
    ...
    config = {
        "seed": args.seed,
        "model_id": args.model_id or base_config.get("model_id") or "microsoft/Phi-3-mini-4k-instruct",
        "model_name": base_config.get("model_name", "phi_3_mini_4k_instruct"),
    ...
    # 3. Load Data
    # Path is: components/router/models/phi_3_mini_4k_instruct/router.py
