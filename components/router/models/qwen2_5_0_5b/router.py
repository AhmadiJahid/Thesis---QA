...
def main():
    ...
    parser.add_argument("--model_id", type=str, default=None, help="Hugging Face model ID (required when no config.json)")
    ...
    # 1. Load Local Config (optional: no config.json in this folder)
    ...
    config = {
        ...
        "model_name": base_config.get("model_name", "qwen2_5_0_5b"),
    ...
    if config["model_id"] is None:
        raise ValueError("--model_id is required when config.json is not present (e.g. in qwen2_5_0_5b)")
    ...
    # 3. Load Data
    # Path is: components/router/models/qwen2_5_1_8b/router.py
    # parents[0]: qwen2_5_1_8b
    # parents[1]: models
    # parents[2]: router
    # parents[3]: components
    # parents[4]: Thesis---QA (Root)
