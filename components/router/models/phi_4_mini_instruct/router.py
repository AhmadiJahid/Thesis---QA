...
def main():
    ...
    config = {
        "seed": args.seed,
        "model_id": args.model_id or base_config.get("model_id") or "microsoft/Phi-4-mini-instruct",
        "model_name": base_config.get("model_name", "phi_4_mini_instruct"),
    ...
    # 3. Load Data
    # Path is: components/router/models/phi_4_mini_instruct/router.py
